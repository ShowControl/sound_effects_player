...
\inputminted[firstline=6,lastline=23]{xml}%
...
\inputminted[firstline=7,lastline=18]{xml}%
...
\inputminted[firstline=20,lastline=32]{xml}%
            {../examples/04/Example_04_sound_sequence.xml}
...
to produce your play you have a right to play its music for your audience.
...
Here are the sequence items which control it,
from {\ttfamily Example\_04\_sound\_sequence.xml}.
\inputminted[firstline=34,lastline=58]{xml}%
            {../examples/04/Example_04_sound_sequence.xml}
This sequence starts the sound, waits for the operator to push the Play
button, then stops the sound.
