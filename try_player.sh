...
rm -f trace.txt
sound_effects_player  --trace-file=trace.txt --trace-sequencer-level=1 ../The_Perils_of_Pauline/Pauline_config.xml
#sound_effects_player -d hdmi:CARD=NVidia,DEV=0 sample/Sample_config.xml
